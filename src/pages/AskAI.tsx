  ...
  const handleAsk = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        addPoints(pts);
        toast.showPoints(pts, "Question answered!");
        ...
        toast.showError("AI Error", result.answer || "Something went wrong. Please try again.");
      }
      setShowAnswer(true);
      ...
      toast.showError("Connection Error", "Cannot reach server. Check your internet connection.");
      setShowAnswer(true);
    } finally {
