      ...
      <nav className="fixed top-0 w-full z-50 glass border-b border-white/5">
        ...
        {mobileMenu && (
          <div className="md:hidden glass border-t border-white/5 px-4 py-4 space-y-3">
            ...
            <button
              onClick={handleGetStarted}
              className="w-full px-4 py-2 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 text-white text-sm font-medium"
            >
              Get Started
            </button>
          </div>
      ...
      <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            The AI-powered study platform that answers your questions, generates
            presentations, converts documents — and{" "}
            <span className="text-purple-400 font-medium">rewards you</span> for
            learning.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto">
              AI-powered tools designed to make learning easier, faster, and
              more rewarding
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                icon: FileText,
                title: "PDF Tools",
                desc: "Convert images to PDF, merge files, compress, split & more — free, no login required!",
              ...
              <div
                ...
                className={`glass rounded-2xl p-6 border border-white/5 hover:border-white/10 transition-all duration-300 group hover:-translate-y-1 ${feature.link ? "cursor-pointer" : ""}`}
              >
                <div
                ...
                <div className="flex items-center justify-between">
                  ...
                  {feature.link && (
                    <span className="text-xs font-semibold text-cyan-400 group-hover:translate-x-1 transition-transform inline-flex items-center gap-1">
                      Try Free →
                    </span>
                  )}
                </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="glass rounded-3xl p-12 border border-purple-500/20">
            ...
            <p className="text-slate-400 mb-8 max-w-2xl mx-auto">
              Join thousands of students already learning smarter and earning
              rewards
            </p>
            <button
              onClick={handleGetStarted}
            ...
            <p className="text-xs text-slate-500 mt-4">
              No credit card required • 100 points welcome bonus
            </p>
          </div>
        </div>
      </section>
