        ...
        <div className="w-72 shrink-0 border-r border-white/5 bg-[#0c0c13] overflow-y-auto max-h-[calc(100vh-100px)] sticky top-0">
          <div className="p-4">
            {courseData.weeks.map(week => {
              ...
              // Week 1 always unlocked. Others: pass allWeeks so isSectionUnlocked
              // can check that ALL sections of prev week are quiz passed
            ...
            <SectionViewer
              ...
              onNext={() => {
                ...
                if (currentIdx < currentWeek.sections.length - 1) {
                  // Next section in same week — only if current section quiz passed
                  ...
                  // Last section of this week — only move to next week if ALL sections quiz passed
