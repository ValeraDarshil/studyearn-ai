// @ts-check — converted from JSX. TODO: add prop types
/**
...
export default function SectionViewer({
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Header */}
      <div className="px-4 py-4 md:px-6 border-b border-white/5">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 md:p-6">
            ...
            <div className="mt-8 pt-6 border-t border-white/5 flex items-center gap-3 flex-wrap">
              {!isContentRead ? (
                <button onClick={handleMarkRead}
                  className={`px-4 py-2.5 md:px-6 md:py-3 rounded-xl bg-gradient-to-r ${courseInfo?.color} text-white font-medium hover:opacity-90 transition-all flex items-center gap-2 text-sm`}>
              ...
              {isContentRead ? (
                <button onClick={() => setActiveTab('quiz')}
                  className="px-4 py-2.5 md:px-6 md:py-3 rounded-xl border border-violet-500/30 text-violet-400 hover:bg-violet-500/10 font-medium transition-all flex items-center gap-2 text-sm">
                  🎯 {t.takeQuiz}
                </button>
              ) : (
          ...
          <div className="max-w-4xl w-full">
            ...
            <div className="bg-[#0d1117] border border-white/10 rounded-xl overflow-hidden">
              ...
              <textarea value={userCode} onChange={e => setUserCode(e.target.value)}
                className="w-full bg-transparent text-gray-200 font-mono text-sm p-3 md:p-4 outline-none resize-none min-h-[200px] md:min-h-[280px] leading-relaxed"
        ...
        {activeTab === 'quiz' && (
          <div className="max-w-2xl">
            ...
            {/* Locked */}
            {!isContentRead && (
              <div className="bg-amber-500/5 border border-amber-500/20 rounded-2xl p-5 md:p-8 text-center">
                ...
                <button onClick={() => setActiveTab('learn')}
                  className={`px-5 py-2.5 md:px-8 md:py-3 rounded-xl bg-gradient-to-r ${courseInfo?.color} text-white font-medium hover:opacity-90 transition-all text-sm`}>
            ...
            {isContentRead && quizResult && !quizResult.passed && (
              <div className="bg-red-500/5 border border-red-500/20 rounded-2xl p-5 md:p-8 text-center">
                <div className="text-5xl mb-4">😅</div>
            ...
            {isContentRead && isQuizPassed && (
              <div className="bg-green-500/5 border border-green-500/20 rounded-2xl p-5 md:p-8 text-center">
                <div className="text-5xl mb-4">🏆</div>
                ...
                <button onClick={onNext}
                  className={`px-5 py-2.5 md:px-8 md:py-3 rounded-xl bg-gradient-to-r ${courseInfo?.color} text-white font-semibold hover:opacity-90 transition-all flex items-center gap-2 mx-auto text-sm`}>
            ...
            {isContentRead && !isQuizPassed && !quizResult && (
              <div className="bg-white/[0.02] border border-white/5 rounded-2xl p-5 md:p-8 text-center">
                <div className="text-5xl mb-4">🎯</div>
