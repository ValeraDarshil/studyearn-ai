...
// File ke top pe add karo (imports ke baad)
function playTourSFX(type: "step" | "complete") {
  try {
    const ctx = new (
    ...
    if (type === "step") {
      // Short click-advance sound: quick rising tone
      ...
      // Completion: cheerful arpeggio C→E→G→C
...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    description:
      "Stuck on a problem? Use Ask AI to get instant answers, solve doubts, and learn faster than ever — like a genius tutor available 24/7!",
    icon: "🤖",
    position: "top",
    accentColor: "#60a5fa",
  ...
  },
  {
    ...
    description:
      "Log in every single day to keep your streak alive. The longer your streak, the bigger your rewards. Consistency is your superpower!",
    icon: "🔥",
    position: "bottom",
    accentColor: "#fb923c",
  ...
  },
  {
    ...
    description:
      "The adventure begins now. Explore every feature, learn something new every day, and level up. Your future self will thank you!",
    icon: "🚀",
    position: "center",
    accentColor: "#34d399",
    ...
    <>
      ...
      <div
        style={{
          ...
          boxShadow: `0 0 0 4px ${accentColor}25, 0 0 32px ${accentColor}60`,
        ...
        >
          <div
            style={{
              ...
              overflow: "hidden",
              background:
                "linear-gradient(175deg, rgba(16,12,40,0.98) 0%, rgba(8,6,22,0.99) 100%)",
          ...
          >
            <div
              style={{ height: 3, background: step.gradient, width: "100%" }}
            />
            <div
              style={{
                position: "absolute",
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          background:
            "linear-gradient(145deg, rgba(10,8,28,0.99), rgba(15,10,36,0.99))",
          border: `1.5px solid ${step.accentColor}35`,
          borderRadius: 22,
      ...
      >
        ...
        <div
          style={{
            position: "absolute",
            inset: 0,
            background: `radial-gradient(ellipse at 50% 0%, ${step.bgGlow} 0%, transparent 65%)`,
            pointerEvents: "none",
          }}
        />
        {/* Shine sweep */}
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              <div
                style={{
                  ...
                  alignItems: "center",
                  justifyContent: "center",
                  boxShadow: `0 0 18px ${step.bgGlow}`,
                }}
              >
                {step.icon}
              </div>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                fontWeight: 700,
                cursor: "pointer",
                boxShadow: `0 4px 22px ${step.bgGlow}`,
                transition: "all 0.2s ease",
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.transform =
                  "translateY(-2px) scale(1.04)";
                e.currentTarget.style.boxShadow = `0 10px 32px ${step.bgGlow}`;
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "none";
                e.currentTarget.style.boxShadow = `0 4px 22px ${step.bgGlow}`;
              }}
            >
              {isLast ? "🚀 Start Learning" : "Next →"}
            </button>
