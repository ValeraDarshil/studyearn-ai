...
function MobileSheet({
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          background: 'linear-gradient(170deg, rgba(12,10,35,0.99) 0%, rgba(8,6,24,0.99) 100%)',
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div>
                <div style={{
                  ...
                  textTransform: 'uppercase', color: step.accentColor, marginBottom: 2,
                }}>
                  Step {stepIndex + 1} of {totalSteps}
                </div>
                {/* Mini progress bar under label */}
                <div style={{
                  width: 80, height: 3, borderRadius: 9999,
            ...
            <button
              ...
              style={{
                ...
                fontSize: 12, color: 'rgba(148,163,184,0.7)',
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 11 }}>
            ...
            <div>
              ...
              {/* Mini progress bar */}
              <div style={{
                width: 72, height: 3, borderRadius: 9999,
        ...
        {/* Title */}
        <h3 style={{
          margin: '0 0 9px', fontSize: 18, fontWeight: 800,
          color: '#f1f5f9', lineHeight: 1.25,
          fontFamily: "'Syne', system-ui, sans-serif",
          letterSpacing: '-0.01em',
        }}>
