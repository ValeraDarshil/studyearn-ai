      ...
      sections: [
        {
          ...
          richContent: [
            {
              ...
              body: 'Python ek programming language hai — computer se baat karne ka tarika. Lekin yeh itna simple hai ki almost English jaisa lagta hai. Google, Netflix, Instagram — sab Python use karte hain.',
            },
            {
              type: 'analogy',
              text: 'Socho computer ek kaam karne wala banda hai jo sirf apni language samajhta hai. Python woh dictionary hai jisse tum usse instructions de sakte ho — simple, clear, aur powerful.',
            },
            {
              type: 'concept',
              heading: 'Tumhara pehla program',
              body: 'print() ek function hai jo kuch bhi screen pe dikhata hai. Jo bhi quotes ke andar likhoge — wahi dikhega.',
            },
            {
              type: 'snippet',
              label: 'Run karke dekho',
              code: 'print("Hello World!")\nprint("Mera naam Python hai!")\nprint("3 months mein pro ban jaunga! 💪")',
              expectedOutput: 'Hello World!\nMera naam Python hai!\n3 months mein pro ban jaunga! 💪',
            },
            {
              type: 'concept',
              heading: 'print() ke saath numbers bhi',
              body: 'Sirf text nahi — numbers bhi directly print ho sakte hain. Aur ek saath multiple cheezein bhi:',
            },
            {
              type: 'snippet',
              label: 'Numbers aur text saath mein',
              code: 'print(42)\nprint(3.14)\nprint("Score:", 100)',
              expectedOutput: '42\n3.14\nScore: 100',
            },
            {
              ...
              wrong: 'Print("Hello")',
              right: 'print("Hello")',
              why: 'Python case-sensitive hai — Print (capital P) kaam nahi karta. Hamesha lowercase print likhna.',
            },
            {
              type: 'mistake',
              wrong: "print('Hello\")",
              right: 'print("Hello")',
              why: 'Opening aur closing quotes match karne chahiye — dono single ya dono double.',
            },
            {
              type: 'checkpoint',
              question: 'print("2 + 2") ka output kya hoga?',
              options: ['4', '"2 + 2"', '2 + 2', 'Error'],
              correct: 2,
              explanation: 'Quotes ke andar likhा kuch bhi literally print hota hai — calculation nahi hoti. "2 + 2" string hai, number nahi.',
            },
          ],
          ...
          task: {
            description: 'Apna naam, sheher aur favorite food — teeno alag alag lines mein print karo! ??? ki jagah apni actual info daalo.',
            hint: 'Teen alag print() statements use karo — ek naam ke liye, ek sheher ke liye, ek food ke liye',
            starterCode: 'print("Mera naam ??? hai")\nprint("Main ??? mein rehta hun")\nprint("Mujhe ??? bahut pasand hai")',
          },
          ...
          quiz: [
            {
              ...
              options: ['display()', 'print()', 'show()', 'write()'],
              correct: 1,
              explanation: 'print() Python ka built-in function hai jo output screen pe dikhata hai.',
              wrong_explanations: {
                0: 'display() JavaScript mein hota hai, Python mein nahi.',
                2: 'show() Python mein exist hi nahi karta.',
                3: 'write() files mein likhne ke liye hai, screen ke liye nahi.',
              },
            },
            {
              ...
              explanation: 'print() quotes ke bahar wali text print karta hai — bina quotes ke.',
              wrong_explanations: {
                0: 'Quotes output mein nahi aate — sirf jo andar hai woh aata hai.',
                2: 'Python capital/small exactly waise print karta hai jaise likha ho.',
                3: 'Yeh valid syntax hai — koi error nahi aayegi.',
              },
            },
            {
              q: 'Python mein Print("Hi") likhne se kya hoga?',
              options: ['Hi print hoga', 'Error aayegi', '"Hi" print hoga', 'Kuch nahi hoga'],
              correct: 1,
              explanation: 'Python case-sensitive hai. Print (capital P) koi function nahi hai — NameError aayegi.',
              wrong_explanations: {
                0: 'Python Print ko nahi pehchanta — yeh defined nahi hai.',
                2: 'Capital P se error aati hai, output nahi.',
                3: 'Error zaroor aayegi — silently fail nahi hota.',
              },
            },
          ],
        },

        {
          ...
          richContent: [
            {
              ...
              body: 'Variable ek labelled dabba hai. Dabba banao, naam do, kuch bhi rakh do. Baad mein sirf naam se nikaal lo.',
            },
            {
              type: 'analogy',
              text: 'Phone mein contacts save karte ho na? "Rahul — 98765" — naam variable ka naam hai, number value hai. Kabhi bhi "Rahul" dhundho toh number mil jaata hai. Python mein exactly waise hi.',
            },
            {
              type: 'snippet',
            ...
            {
              type: 'concept',
              heading: 'Teen main data types',
              body: 'Python mein teen common types hain: String (text, quotes mein), Integer (whole number), Float (decimal number).',
            },
            {
              type: 'snippet',
              label: 'Teeno types ko dekho',
              code: 'student_naam = "Priya"     # String\nstudent_age  = 17          # Integer\nstudent_gpa  = 9.2         # Float\n\nprint(student_naam)\nprint(student_age)\nprint(student_gpa)',
              expectedOutput: 'Priya\n17\n9.2',
            },
            {
              type: 'concept',
              heading: 'Variable update karna',
              body: 'Variable ki value kabhi bhi badal sakte ho — sirf dobara assign karo:',
            },
            {
              type: 'snippet',
            ...
            },
            {
              ...
              wrong: '2score = 100',
              right: 'score2 = 100',
              why: 'Variable naam number se start nahi ho sakta. Letter ya underscore se shuru karo.',
            },
            {
              type: 'mistake',
              wrong: 'student naam = "Rahul"',
              right: 'student_naam = "Rahul"',
              why: 'Variable naam mein spaces nahi hote — underscore (_) use karo.',
            },
            {
              type: 'checkpoint',
              question: 'x = 5, phir x = x + 3 likhne ke baad x ki value kya hogi?',
              options: ['5', '3', '8', 'Error'],
              correct: 2,
              explanation: 'x = x + 3 matlab pehle right side calculate karo: 5 + 3 = 8. Phir x mein 8 store ho jaata hai.',
            },
          ],
          ...
          task: {
            description: 'Apna profile banao — naam, age, favourite_subject, percentage — 4 variables. Phir print karo saari info. ??? replace karo apni real values se.',
            hint: '4 variables banao. String ke liye quotes lagana mat bhoolna — naam = "Rahul", age = 18 (no quotes for numbers).',
            starterCode: 'naam = "???"\nage = ???\nfavourite_subject = "???"\npercentage = ???\n\nprint("Naam:", naam)\nprint("Age:", age)\nprint("Subject:", favourite_subject)\nprint("Percentage:", percentage)',
          },

          quiz: [
            {
              q: 'naam = "Rahul" mein "Rahul" kis type ka data hai?',
              options: ['Integer', 'Float', 'String', 'Boolean'],
              correct: 2,
              explanation: 'Quotes ke andar jo bhi ho — woh String hota hai. "Rahul" text hai, isliye String.',
              wrong_explanations: {
                0: 'Integer whole numbers hote hain jaise 5, 100 — quotes ke bina.',
                1: 'Float decimal numbers hote hain jaise 9.5 — quotes ke bina.',
                3: 'Boolean sirf True ya False hota hai.',
              },
            },
            {
              q: 'Kaunsa variable name valid nahi hai?',
              options: ['my_score', 'score1', '_temp', '1name'],
              correct: 3,
              explanation: 'Variable naam number se start nahi ho sakta. 1name invalid hai — name1 sahi hota.',
              wrong_explanations: {
                0: 'my_score valid hai — underscore allowed hai.',
                1: 'score1 valid hai — end mein number allowed hai.',
                2: '_temp valid hai — underscore se shuru kar sakte hain.',
              },
            },
            {
              q: 'age = 17 mein 17 kis type ka hai?',
              options: ['String', 'Float', 'Integer', 'Boolean'],
              correct: 2,
              explanation: 'Quotes ke bina whole number = Integer. 17 koi decimal nahi, koi quotes nahi — Integer hai.',
              wrong_explanations: {
...

        {
          ...
          richContent: [
            {
              ...
              body: 'Abhi tak values tumne khud likhte the code mein. input() se program user se directly pooch sakta hai — program pause hota hai, user type karta hai, value aa jaati hai.',
            },
            {
              type: 'snippet',
              label: 'Basic input — try it',
              code: '# input() browser mein prompt box kholega\nnaam = input("Apna naam batao: ")\nprint("Hello", naam, "! Welcome! 🎉")',
              expectedOutput: '(Ek prompt box aayega — apna naam type karo)',
            },
            {
              type: 'concept',
              heading: 'Important: input() hamesha String deta hai',
              body: 'Yeh sabse common confusion hai. User "25" type kare ya "hello" — dono String hote hain. Number chahiye toh convert karna padega:',
            },
            {
              type: 'snippet',
              label: 'Number input — int() se convert karo',
              code: 'umar = int(input("Tumhari age kya hai? "))\nagla_saal = umar + 1\nprint(f"Agle saal tum {agla_saal} saal ke honge!")',
              expectedOutput: '(Number type karo — result calculate hoga)',
            },
            {
              type: 'snippet',
              label: 'Float input — decimal numbers ke liye',
              code: 'score = float(input("Tumhara score (0-10): "))\npercentage = score * 10\nprint(f"Percentage: {percentage}%")',
              expectedOutput: '(Decimal number dalo jaise 8.5)',
            },
            {
              type: 'mistake',
              wrong: 'umar = input("Age: ")\nprint(umar + 1)',
              right: 'umar = int(input("Age: "))\nprint(umar + 1)',
              why: 'input() string deta hai — "25" + 1 nahi hoga, TypeError aayega. int() se pehle convert karo.',
            },
            {
              type: 'concept',
              heading: 'f-strings — clean printing',
              body: 'f"..." mein {} ke andar variable seedha daaldo — print mein + se jodhne ki zarurat nahi:',
            },
            {
              type: 'snippet',
              label: 'f-string magic',
              code: 'naam = input("Naam: ")\ncity = input("Sheher: ")\nprint(f"{naam} {city} se hai — welcome! 🙌")',
              expectedOutput: '(Naam aur sheher dalo — combined print hoga)',
            },
            {
              type: 'checkpoint',
              question: 'age = input("Age: ") — user "20" type kare toh age ka type kya hoga?',
              options: ['Integer (20)', 'String ("20")', 'Float (20.0)', 'Depends on user'],
              correct: 1,
              explanation: 'input() hamesha String return karta hai — chahe user number likhe ya text. "20" string hai, 20 integer.',
            },
          ],
          ...
          task: {
            description: 'User se naam aur favourite number lo. Phir print karo: "[naam] ka favourite number [number] hai, aur uska double [2x] hai!"',
            hint: 'naam = input(...), number = int(input(...)), phir double = number * 2',
            starterCode: 'naam   = input("Apna naam: ")\nnumber = int(input("Favourite number: "))\ndouble = ???\n\nprint(f"{naam} ka favourite number {number} hai!")\nprint(f"Uska double hai: {???}")',
          },
          ...
          quiz: [
            {
              ...
              explanation: 'input() hamesha String return karta hai — chahe user number type kare ya text.',
              wrong_explanations: {
                0: 'Integer nahi — chahe user 42 type kare, "42" string milegi.',
                1: 'Float bhi nahi — convert karna padta hai float() se.',
                3: 'Nahi — hamesha String, no matter what user types.',
              },
            },
            {
              q: 'User se integer input lene ka sahi tarika kaunsa hai?',
              options: ['input(int("Age: "))', 'int(input("Age: "))', 'integer(input("Age: "))', 'input("Age: ", int)'],
              correct: 1,
              explanation: 'int() bahar, input() andar — pehle input() se string milti hai, phir int() convert karta hai.',
              wrong_explanations: {
                0: 'Yeh syntax galat hai — int() ke andar "Age: " string hai, woh input nahi maangega.',
                2: 'integer() Python mein exist nahi karta — int() likhte hain.',
                3: 'input() mein sirf ek argument hota hai — prompt string.',
              },
            },
            {
              q: 'f"Hello {naam}" mein {naam} ki jagah kya aayega?',
              options: ['{naam} literally', 'naam ka actual value', 'String "naam"', 'Error'],
              correct: 1,
              explanation: 'f-string mein {} ke andar variable ka actual value aata hai — jo variable mein stored hai.',
              wrong_explanations: {
                0: 'Curly braces {} output mein nahi aate — woh placeholder hain.',
                2: '"naam" string nahi aayega — variable ki value aayegi.',
                3: 'Koi error nahi — yeh valid f-string syntax hai.',
              },
            },
          ],
        },

        {
          ...
          richContent: [
            {
              ...
              body: '+ - * / toh basic hain. Python mein teen aur powerful operators hain jo interviews mein kaam aate hain.',
            },
            {
              type: 'snippet',
              label: 'Sab operators ek saath — run karo',
              code: 'a = 17\nb = 5\n\nprint("Add:     ", a + b)   # 22\nprint("Subtract:", a - b)   # 12\nprint("Multiply:", a * b)   # 85\nprint("Divide:  ", a / b)   # 3.4\nprint("Floor:   ", a // b)  # 3  (decimal hata do)\nprint("Modulus: ", a % b)   # 2  (remainder)\nprint("Power:   ", a ** b)  # 17^5 = 1419857',
              expectedOutput: 'Add:      22\nSubtract: 12\nMultiply: 85\nDivide:   3.4\nFloor:    3\nModulus:  2\nPower:    1419857',
            },
            {
              type: 'concept',
              heading: '% (modulus) — sirf remainder',
              body: '17 % 5 = 2 kyunki 17 = 5×3 + 2. Yeh operator even/odd check karne ke liye bahut use hota hai — agar number % 2 == 0 toh even.',
            },
            {
              type: 'snippet',
              label: 'Even/Odd checker — classic use of %',
              code: 'number = 42\nif number % 2 == 0:\n    print(f"{number} even hai")\nelse:\n    print(f"{number} odd hai")',
              expectedOutput: '42 even hai',
            },
            {
              type: 'concept',
              heading: 'f-strings mein formatting',
              body: '{value:.2f} ka matlab hai "2 decimal places tak dikhao" — percentage aur money ke liye zaroori.',
            },
            {
              type: 'snippet',
              label: 'Percentage calculator — real example',
              code: 'naam     = "Vikram"\nmarks    = 450\ntotal    = 500\npercent  = (marks / total) * 100\n\nprint(f"{naam} ka result:")\nprint(f"Marks:      {marks}/{total}")\nprint(f"Percentage: {percent:.2f}%")',
              expectedOutput: 'Vikram ka result:\nMarks:      450/500\nPercentage: 90.00%',
            },
            {
              type: 'mistake',
              wrong: 'print("2 + 2")',
              right: 'print(2 + 2)',
              why: '"2 + 2" quotes ke andar hai — string hai. Calculation ke liye quotes ke bahar likhna.',
            },
            {
              type: 'mistake',
              wrong: 'result = 10 / 0',
              right: 'if b != 0:\n    result = a / b',
              why: 'Zero se divide karna ZeroDivisionError deta hai. Real code mein check zaroor karo.',
            },
            {
              type: 'checkpoint',
              ...
              options: ['3', '2', '3.4', '0'],
              correct: 1,
              explanation: '17 ko 5 se divide karo: 5×3=15, remainder = 17-15 = 2. Modulus sirf remainder deta hai.',
            },
          ],
          ...
          task: {
            description: 'Simple EMI calculator: user se loan amount aur years lo. Total = amount + (amount × 0.1 × years), Monthly = total ÷ (years × 12). ??? fill karo.',
            hint: 'tip = bill * tip_pc / 100, total = bill + tip. f-string mein {variable:.2f} se 2 decimal places aate hain.',
          ...
          quiz: [
            {
              ...
              explanation: '17 divide by 5 = 3 remainder 2. Modulus (%) sirf remainder deta hai.',
              wrong_explanations: {
                0: '3 floor division ka result hoga (17//5) — modulus alag hota hai.',
                2: '3.4 regular division ka result hoga (17/5) — modulus remainder deta hai.',
                3: 'Zero tab hota jab perfectly divide ho — 17 mein 5 perfectly divide nahi hota.',
              },
            },
            {
              q: 'f"Result: {percentage:.2f}%" mein :.2f kya karta hai?',
              options: ['2 digits total dikhata hai', '2 decimal places tak round karta hai', 'Float mein convert karta hai', 'Error deta hai'],
              correct: 1,
              explanation: ':.2f format specifier hai — f matlab float, .2 matlab 2 decimal places.',
              wrong_explanations: {
                0: '2 total digits nahi — 2 decimal places ke baad ki digits.',
                2: 'Float conversion alag hoti hai — int() ya float() se karte hain.',
                3: 'Yeh valid Python syntax hai — koi error nahi.',
              },
            },
            {
              q: '10 // 3 ka result kya hoga?',
              ...
              explanation: 'Floor division (//) decimal part hata deta hai — 10/3 = 3.33, floor = 3.',
              wrong_explanations: {
                0: '3.33 regular division (10/3) ka result hai — // floor deta hai.',
                2: '4 ceiling hota — floor 3 hai kyunki neeche round karte hain.',
                3: '1 modulus ka result hoga (10%3) — floor division alag hai.',
              },
            },
          ],
        },
