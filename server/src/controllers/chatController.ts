...
export async function getConversations(req: Request, res: Response) {
  try {
    ...
    logger.error({ err: err.message }, 'getConversations error');
    res.status(500).json({ success: false, message: 'Failed to load conversations' });
  }
}
...
export async function getConversation(req: Request, res: Response) {
  try {
    ...
    logger.error({ err: err.message }, 'getConversation error');
    res.status(500).json({ success: false, message: 'Failed to load conversation' });
  }
}
...
export async function createConversation(req: Request, res: Response) {
  try {
    ...
    logger.error({ err: err.message }, 'createConversation error');
    res.status(500).json({ success: false, message: 'Failed to create conversation' });
  }
}
...
export async function appendMessages(req: Request, res: Response) {
  try {
    ...
    logger.error({ err: err.message }, 'appendMessages error');
    res.status(500).json({ success: false, message: 'Failed to save messages' });
  }
}
...
export async function renameConversation(req: Request, res: Response) {
  try {
    ...
    logger.error({ err: err.message }, 'renameConversation error');
    res.status(500).json({ success: false, message: 'Failed to rename' });
  }
}
...
export async function deleteConversation(req: Request, res: Response) {
  try {
    ...
    logger.error({ err: err.message }, 'deleteConversation error');
    res.status(500).json({ success: false, message: 'Failed to delete' });
  }
}